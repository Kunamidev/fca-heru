...
npm i fca-heru
```
It will download `fca-heru` from NPM repositories
...
You can see it [here](https://github.com/Schmavery/facebook-chat-api/blob/master/README.md).
